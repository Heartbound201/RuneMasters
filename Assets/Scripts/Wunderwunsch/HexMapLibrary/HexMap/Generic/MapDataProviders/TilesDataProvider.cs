...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    {
        private Dictionary<Vector3Int, HexTile<T>> tilesByPosition;
        private TilePositionsProvider tilesPositionsProvider;

        public TilesDataProvider(Dictionary<Vector3Int, HexTile<T>> tilesByPosition, TilePositionsProvider tilesPositionsProvider)
        {
        ...
        public List<HexTile<T>> AdjacentToTile(Tile tile)
        {
        ...
        /// returns the map tiles adjacent to the input tile
        /// </summary>   
        public List<HexTile<T>> AdjacentToTile(Vector3Int tilePosition)
        {
        ...
        public List<HexTile<T>> AdjacentToEdge(Vector3Int edge)
        {
        ...
        /// returns the map tiles adjacent to the input edge
        /// </summary>   
        public List<HexTile<T>> AdjacentToEdge(Edge edge)
        {
        ...
        public List<HexTile<T>> AdjacentToCorner(Vector3Int corner)
        {
        ...
        /// returns the map tiles adjacent to the input corner
        /// </summary>   
        public List<HexTile<T>> AdjacentToCorner(Corner corner)
        {
        ...
        public List<HexTile<T>> Cone(Tile origin, Vector3Int targetDirection, float coneHalfAngle, int coneLength)
        {
        ...
        /// returns all map tiles of a cone starting at a point with given direction, length and width
        /// </summary>
        public List<HexTile<T>> Cone(Vector3Int origin, Vector3Int targetDirection, float coneHalfAngle, int coneLength)
        {
        ...
        public List<HexTile<T>> Line(Tile origin, Vector3Int target, bool includeOrigin, float horizontalNudgeFromOriginCenter = NudgePositive)
        {
        ...
        /// returns tiles forming a line between origin and target tile, optionally including the origin tile itself
        /// </summary>
        public List<HexTile<T>> Line(Vector3Int origin, Vector3Int target, bool includeOrigin, float horizontalNudgeFromOriginCenter = NudgePositive)
        {
        ...
        public List<HexTile<T>> Ring(Tile center, int radius, int thicknessInwards)
        {
        ...
        /// returns all map tiles of a ring around center in no defined order
        /// </summary>
        public List<HexTile<T>> Ring(Vector3Int center, int radius, int thicknessInwards)
        {
        ...
        /// </summary>
        public List<HexTile<T>> Ring(Tile center, int radius, TileDirection startDirection, bool clockwise)
        {
        ...
        ///  returns all map tiles of a ring around center in order specified by parameters (startDirection, clockwise)
        /// </summary>
        public List<HexTile<T>> Ring(Vector3Int center, int radius, TileDirection startDirection, bool clockwise)
        {
        ...
        public List<HexTile<T>> Disc(Tile center, int range, bool includeCenter)
        {
        ...
        /// Returns all tiles of the map which are within distance of the center point, either with or without the center point
        /// </summary>
        public List<HexTile<T>> Disc(Vector3Int center, int range, bool includeCenter)
        {
        ...
        public List<List<HexTile<T>>> ContiguousAreasOfInputTiles(ICollection<Tile> inputTiles)
        {
            List<List<HexTile<T>>> areas = new List<List<HexTile<T>>>();
        ...
        /// </summary>
        /// ![left = input tile list , right = output separated into different areas](Map_GetTiles_ContiguousCombined.png)
        public List<List<HexTile<T>>> ContiguousAreasOfInputTiles(ICollection<Vector3Int> inputTiles)
        {
            List<List<HexTile<T>>> areas = new List<List<HexTile<T>>>();
        ...
        /// </summary>
        private List<HexTile<T>> GetTilesFromCoordinates(ICollection<Vector3Int> coordinates)
        { 
            List<HexTile<T>> tiles = new List<HexTile<T>>();
