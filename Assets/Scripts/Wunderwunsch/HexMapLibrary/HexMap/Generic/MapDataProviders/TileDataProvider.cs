...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    { 
        ...
        public TileDataProvider(Dictionary<Vector3Int, HexTile<T>> tilesByPosition, TilePositionProvider tilePositionProvider)
        {
        ...
        /// <returns></returns>
        public HexTile<T> FromCartesianCoordinate(Vector3 cartesianCoordinate)
        {
        ...
        /// </summary>
        public HexTile<T> FromTileRotated60DegreeClockwise(Vector3Int center, Vector3Int pointToRotate)
        {
        ...
        /// rotates the input tile coordinate 60° Clockwise around the specified center point and returns the tile on that position. returns null if outside of map bounds
        /// </summary>
        public HexTile<T> FromTileRotated60DegreeClockwise(HexTile<T> center, HexTile<T> pointToRotate)
        {
        ...
        /// </summary>
        public HexTile<T> FromTileRotated60DegreeCounterClockwise(Vector3Int center, Vector3Int pointToRotate)
        {
        ...
        /// rotates the input tile coordinate 60° Counter-clockwise around the specified center point and returns the tile on that position. returns null if outside of map bounds
        /// </summary>
        public HexTile<T> FromTileRotated60DegreeCounterClockwise(HexTile<T> center, HexTile<T> pointToRotate)
        {
