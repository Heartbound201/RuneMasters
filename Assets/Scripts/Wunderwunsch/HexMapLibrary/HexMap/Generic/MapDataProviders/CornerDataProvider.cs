...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    public class CornerDataProvider<C> where C : new()
    {
        ...
        public CornerDataProvider(Dictionary<Vector3Int, HexCorner<C>> cornersByPosition, CornerPositionProvider cornerPositionProvider)
        {
        ...
        /// </summary>        
        public HexCorner<C> FromCartesianCoordinate(Vector3 cartesianCoordinate)
        {
