...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    public class EdgesDataProvider<E> where E : new()
    {
        ...
        public EdgesDataProvider(Dictionary<Vector3Int, HexEdge<E>> edgesByPosition, EdgePositionsProvider edgesPositionsProvider)
        {
        ...
        public List<HexEdge<E>> AdjacentToEdge(Vector3Int edge)
        {
        ...
        /// </summary>        
        public List<HexEdge<E>> AdjacentToEdge(Edge edge)
        {
        ...
        public List<HexEdge<E>> AdjacentToCorner(Vector3Int corner)
        {
        ...
        /// </summary>        
        public List<HexEdge<E>> AdjacentToCorner(Corner corner)
        {
        ...
        public List<HexEdge<E>> OfTile(Vector3Int tile)
        {
        ...
        /// </summary>        
        public List<HexEdge<E>> OfTile(Tile tile)
        {
        ...
        public List<HexEdge<E>> WithinDistanceOfEdge(Vector3Int centerEdge, int maxDistance, bool includeSelf)
        {
        ...
        /// </summary>        
        public List<HexEdge<E>> WithinDistanceOfEdge(Edge centerEdge, int maxDistance, bool includeSelf)
        {
        ...
        public List<HexEdge<E>> WithinDistanceOfCorner(Vector3Int centerCorner, int maxDistance)
        {
        ...
        /// </summary>        
        public List<HexEdge<E>> WithinDistanceOfCorner(Corner centerCorner, int maxDistance)
        {
        ...
        public List<HexEdge<E>> AtExactDistance(Vector3Int centerEdge, int distance)
        {
        ...
        public List<HexEdge<E>> PathBetweenCorners(Vector3Int originCorner, Vector3Int targetCorner, float horizontalNudgeFromOriginCenter = NudgePositive)
        {
        ...
        public List<HexEdge<E>> TileBorders(IEnumerable<Vector3Int> tiles)
        {
        ...
        /// returns all the border edges of a set of tiles. 
        /// </summary>
        public List<HexEdge<E>> TileBorders(IEnumerable<Tile> tiles)
        {
            var edges = edgesPositionsProvider.TileBorders(tiles);
            return GetEdgesFromCoordinates(edges);
        }
        ...
        /// </summary>
        private List<HexEdge<E>> GetEdgesFromCoordinates<Coords>(Coords coordinates) where Coords : ICollection<Vector3Int>
        {
            List<HexEdge<E>> edges = new List<HexEdge<E>>();
