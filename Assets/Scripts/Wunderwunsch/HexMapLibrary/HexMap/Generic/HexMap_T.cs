...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    public class HexMap<T> : HexMap where T : new()
    {
        ...
        public Dictionary<Vector3Int, HexTile<T>> TilesByPosition { get; private set; }
        public HexTile<T>[] Tiles { get; private set; }
        ...
        public void CreateTileData()
        {
            ...
            TilesByPosition = new Dictionary<Vector3Int, HexTile<T>>(vector3IntEqualityComparer);
            Tiles = new HexTile<T>[TileIndexByPosition.Count];
            ...
            {                
                ...
                HexTile<T> hexTile = new HexTile<T>(kvp.Key, kvp.Value, normalizedPosition);
                TilesByPosition.Add(kvp.Key, hexTile);
                Tiles[hexTile.Index] = hexTile;
            }
        }        
    }
}