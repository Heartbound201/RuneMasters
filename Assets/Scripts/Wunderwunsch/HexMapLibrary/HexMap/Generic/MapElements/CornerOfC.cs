...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    /// </summary>    
    public class HexCorner<C> : Corner where C : new()
    {
        /// <summary>
        ...
        /// </summary>
        public HexCorner(Vector3Int position, int index, Vector2 normalizedPosition, bool createDefaultDataObject = true) : base(position, index, normalizedPosition)
        {
        ...
        /// </summary>  
        public HexCorner(Vector3Int position, int index, Vector2 normalizedPosition, C data) : base(position, index, normalizedPosition)
        {
            Data = data;
        }
    }
