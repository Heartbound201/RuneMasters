...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    /// </summary>    
    public class HexEdge<E> : Edge where E : new()
    {
        /// <summary>
        ...
        /// </summary>
        public HexEdge(Vector3Int position, int index, Vector2 normalizedPosition, bool createDefaultDataObject = true) : base(position, index, normalizedPosition)
        {
        ...
        /// </summary>  
        public HexEdge(Vector3Int position, int index, Vector2 normalizedPosition, E data) : base(position, index, normalizedPosition)
        {
            Data = data;
        }
    }
