...
namespace Wunderwunsch.HexMapLibrary.Generic
{
    ...
    /// </summary>    
    public class HexTile<T> : Tile where T : new()
    {
        /// <summary>
        ...
        /// </summary>
        public HexTile(Vector3Int position, int index, Vector2 normalizedPosition, bool createDefaultDataObject = true) : base(position, index, normalizedPosition)
        {
        ...
        /// </summary>        
        public HexTile(Vector3Int position, int index, Vector2 normalizedPosition, T data) : base(position, index, normalizedPosition)
        {
            Data = data;
        }
    }
